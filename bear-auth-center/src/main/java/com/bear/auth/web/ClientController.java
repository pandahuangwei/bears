...
public class ClientController {
    ...
    private void checkSystemClient(String clientId) {
        if (CommonConstants.CLIENT_ID.equals(clientId)) {
    ...
    private boolean isSystemClient(ClientDetails clientDetails) {
        ...
        boolean isSystem = CommonConstants.CLIENT_ID.equalsIgnoreCase(baseClientDetails.getClientId());
